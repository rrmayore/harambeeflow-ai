...
export default function CommunicationsAutomationCenter({
  ...
  return (
    <div className="flex-1 bg-slate-50 text-slate-900 p-3 md:p-6 space-y-6 flex flex-col min-h-[calc(100vh-100px)] font-sans">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-1.5 shadow-xs overflow-x-auto scrollbar-none flex items-center justify-start gap-1">
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2.5 text-xs font-bold rounded-xl whitespace-nowrap transition-all cursor-pointer ${
                isActive 
